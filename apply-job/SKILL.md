...
Project files for this installation are at:
`PersonalOS/JobSearch/` (relative to AI Workspace root)

`PROFILE.md`, `BULLETS.md`, `CONTEXT.md`, and `base/resume_ats_base.docx` live there.
