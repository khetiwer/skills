...
This document defines the JSON schemas used by create-skill's eval pipeline.
...
Tracks version progression across eval iterations. Located at workspace root.
